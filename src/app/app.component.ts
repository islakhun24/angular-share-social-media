  ...
  ngOnInit(){
    ...
    if (this.metadataService) {
      this.metadataService.updateMetadata({
          title: 'PJCSISSSS (Persatuan Jasmine Cantik Seluruh Indonesia) testing',
